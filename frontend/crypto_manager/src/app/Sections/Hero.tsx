	...
	return(
		<section className="max-w-[100vw]">
			<div className="translate-y-12 flex flex-col w-full items-center justify-center relative container mx-auto max-w-screen-xl">
				<div className="-z-10 absolute inset-0 -top-96 flex flex-row h-[80svh] justify-start gap-8 overflow-hidden w-full items-end [mask-image:linear-gradient(to_right,transparent_30%,black_45%,black_55%,transparent_98%)] blur-[2px] ">
					{candlebars.map(item => (
            <div key={item.id} className={(item.id === 0 || (item.value >= candlebars[item.id - 1].value))? "bg-lime-500 w-2 rounded-full [mask-image:linear-gradient(to_top,transparent_15%,black_35%,black_65%,transparent_85%)]":"bg-red-500 w-2 rounded-full [mask-image:linear-gradient(to_top,transparent_15%,black_35%,black_65%,transparent_85%)]"} style={{ height: `${item.value * 5}%`}}></div>
          ))}
				</div>
				<div className="-z-10 absolute inset-0 -top-96 flex flex-row h-[80svh] justify-start gap-8 overflow-hidden w-full items-end [mask-image:linear-gradient(to_right,transparent_30%,black_45%,black_55%,transparent_98%)] blur-[2px] ">
					{candlebars.map(item => (
            <div key={item.id} className={(item.id === 0 || (item.value >= candlebars[item.id - 1].value))? "bg-lime-500 w-2 rounded-full [mask-image:linear-gradient(to_top,transparent_15%,black_25%,black_75%,transparent_85%)]":"bg-red-500 w-2 rounded-full [mask-image:linear-gradient(to_top,transparent_25%,black_35%,black_75%,transparent_85%)]"} style={{ height: `${item.value * 5}%`}}></div>
				...
				<div className="w-full flex flex-col items-center justify-center py-10">
					<div className="text-center font-mono text-transparent bg-gradient-to-t pb-2 from-black/50 to-black/85 bg-clip-text text-7xl max-w-3xl text-balance font-medium">Crypto forecasting and tracking.</div>
					<div className="text-center text-3xl text-neutral-950/70 max-w-3xl text-balance mt-4 font-light">We developed an app to visualize the crypto market while being able to make forecasts and predictions.</div>
					<div className="flex mt-6 py-4 gap-4">
						<button className="ml-1 bg-lime-500 text-white px-4 py-1.5 rounded-full font-semibold hover:bg-lime-600 transition">Get Started</button>
						<button className="ml-1 bg-black/65 text-white px-4 py-1.5 rounded-full font-semibold hover:bg-black/35 transition">Learn More</button>
					</div>

				</div>
				<div className="flex w-full items-center justify-center">
					<div className="flex w-full justify-center border rounded-2xl backdrop-blur-sm">
						<div className="flex flex-col mt-8">
							<div className="flex w-full text-center justify-center py-8 font-mono text-black/70 text-2xl">Discover a large selection of coins</div>
							
							<div className="flex flex-row px-4 justify-evenly gap-4">
								<div className="border relative border-white/15 rounded-xl size-16 p-2 backdrop-blur-sm overflow-hidden hover:scale-105 hover:-translate-y-1 transition">
									...
									<svg className="absolute inset-0 blur-md -z-10" xmlns="http://www.w3.org/2000/svg" aria-label="Ethereum" role="img" viewBox="0 0 512 512" fill="#000000"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"><rect width="512" height="512" rx="15%" fill="#ffffff00"></rect><path fill="#3C3C3B" d="m256 362v107l131-185z"></path><path fill="#343434" d="m256 41l131 218-131 78-132-78"></path><path fill="#8C8C8C" d="m256 41v158l-132 60m0 25l132 78v107"></path><path fill="#141414" d="m256 199v138l131-78"></path><path fill="#393939" d="m124 259l132-60v138"></path></g></svg>
								</div>
								<div className="border relative border-white/5 rounded-xl size-16 p-2 backdrop-blur-sm overflow-hidden hover:scale-105 hover:-translate-y-1 transition">
									...
									<svg className="absolute inset-0 blur-md -z-10" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <g fill="none"> <circle cx="16" cy="16" r="16" fill="#F3BA2F"></circle> <path fill="#FFF" d="M12.116 14.404L16 10.52l3.886 3.886 2.26-2.26L16 6l-6.144 6.144 2.26 2.26zM6 16l2.26-2.26L10.52 16l-2.26 2.26L6 16zm6.116 1.596L16 21.48l3.886-3.886 2.26 2.259L16 26l-6.144-6.144-.003-.003 2.263-2.257zM21.48 16l2.26-2.26L26 16l-2.26 2.26L21.48 16zm-3.188-.002h.002V16L16 18.294l-2.291-2.29-.004-.004.004-.003.401-.402.195-.195L16 13.706l2.293 2.293z"></path> </g> </g></svg>
								</div>
								<div className="border relative border-white/5 rounded-xl size-16 p-2 backdrop-blur-sm overflow-hidden hover:scale-105 hover:-translate-y-1 transition">
								...
								<div className="border relative border-white/5 rounded-xl size-16 p-2 backdrop-blur-sm overflow-hidden hover:scale-105 hover:-translate-y-1 transition">
									...
									<svg className="absolute inset-0 blur-md -z-10" viewBox="0.004 0 64 64" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M63.04 39.741c-4.274 17.143-21.638 27.575-38.783 23.301C7.12 58.768-3.313 41.404.962 24.262 5.234 7.117 22.597-3.317 39.737.957c17.144 4.274 27.576 21.64 23.302 38.784z" fill="#f7931a"></path><path d="M46.11 27.441c.636-4.258-2.606-6.547-7.039-8.074l1.438-5.768-3.512-.875-1.4 5.616c-.922-.23-1.87-.447-2.812-.662l1.41-5.653-3.509-.875-1.439 5.766c-.764-.174-1.514-.346-2.242-.527l.004-.018-4.842-1.209-.934 3.75s2.605.597 2.55.634c1.422.355 1.68 1.296 1.636 2.042l-1.638 6.571c.098.025.225.061.365.117l-.37-.092-2.297 9.205c-.174.432-.615 1.08-1.609.834.035.051-2.552-.637-2.552-.637l-1.743 4.02 4.57 1.139c.85.213 1.683.436 2.502.646l-1.453 5.835 3.507.875 1.44-5.772c.957.26 1.887.5 2.797.726L27.504 50.8l3.511.875 1.453-5.823c5.987 1.133 10.49.676 12.383-4.738 1.527-4.36-.075-6.875-3.225-8.516 2.294-.531 4.022-2.04 4.483-5.157zM38.087 38.69c-1.086 4.36-8.426 2.004-10.807 1.412l1.928-7.729c2.38.594 10.011 1.77 8.88 6.317zm1.085-11.312c-.99 3.966-7.1 1.951-9.083 1.457l1.748-7.01c1.983.494 8.367 1.416 7.335 5.553z" fill="#ffffff"></path></g></svg>
								</div>
								<div className="border relative border-white/5 rounded-xl size-16 p-2 backdrop-blur-sm overflow-hidden hover:scale-105 hover:-translate-y-1 transition">
							...
							<div className="mt-8 text-black/30 text-center text-balance mb-8 max-w-2xl">
								Our service extends more than 300+ cryptocurrencies tracking and forecasting solutions.
							</div>
